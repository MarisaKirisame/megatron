...
def per_trace(trace_out_path):
    ...
    for l in readlines_file(trace_out_path):
        ...
        header = ["name", "diff_num", "read_count", "write_count", "meta_read_count", "meta_write_count", "queue_size_acc", "input_change_count", "output_change_count", "tree_size", "overhead_time", "queue_time", "om_time", "eval_time", "command", "full_command", "html", "time"]
        diff_num = j["diff_num"]
